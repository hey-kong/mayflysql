from mayflysql.core import TYPE_MAP, FieldKey, FieldType
...
class Field(SerializedInterface):
    ...
    def deserialized(data):
        ...
        obj = Field(FieldType(json_data['type']), keys, json_data['default'])
